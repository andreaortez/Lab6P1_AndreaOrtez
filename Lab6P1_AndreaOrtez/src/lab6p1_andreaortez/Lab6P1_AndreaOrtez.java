                ...
                case 2:
                    ...
                    do {
                        ...
                        if (num < 1000 || num > 9999) {
                            ...
                            int[] var2 = ConversionArray(num);
                            if (var2[0] == var2[1] && var2[0] == var2[2] && var2[0] == var2[3]) {
                                valid = false;
                            }
                        }
                    } while (!valid);
                    ...
                    do {
                        ...
                        num = Resta(Descendente(ConversionArray(num)), Ascendente(ConversionArray(num)));
                        cont++;
                    } while (num != 6174 && cont < 8);
                    System.out.println();
            }
        } while (opcion
                != 3);
    ...
    public static int[] Ascendente(int[] array) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            for (int j = i + 1; j < 4; j++) {
                ...
                if (menor >= b) {
                    menor = b;//Si encuentra un valor menor al original, se sustituye para conservar el nuevo valor
